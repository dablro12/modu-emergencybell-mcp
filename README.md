...
행안부·NEMC·카카오 로컬 등 **공공데이터**를 바탕으로 화장실·응급의료·안전비상벨·접근성 시설을 **위치·상황**에 맞게 찾아주는 MCP 서버입니다.

**핵심 기능**
- 위치 기반 화장실·약국·응급실·안전비상벨 검색 (카카오맵·지도 이미지 포함)
- 중독·오복용·증상 → 트리아지·진료과·119/112/1339 안내
- 휠체어·유아·노약자·외국인 맞춤 필터 및 문장 카드
- 지하철 짐보관·WiFi·동물병원·쉼터 등 생활 편의 통합

**실사용 예시**  
카카오톡에서 「익선동인데 엄마 무릎에서 피 나 — 응급실이랑 약국 알려줘」처럼 **급한 상황을 한 마디**로 말하면, AI가 위치·상황·긴급도를 읽어 **119/112 안내 → 가까운 응급실·약국 → 지도·다음 행동**까지 한 번에 연결합니다. 앱을 여러 개 뒤지지 않고, **그 순간 필요한 것만** 빠르게 찾는 플랫폼입니다.
