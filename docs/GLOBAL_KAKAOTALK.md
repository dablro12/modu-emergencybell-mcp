...
"급할 때 필요한 정보를 알려드려요."  
**모두의비상벨**은 위기 순간, 지금 무엇부터 해야 할지 빠르게 안내하는 생활안전 도우미입니다.

- 아이가 아프거나 가족이 다친 **보호자·일반 시민**
- 밤길과 치안이 걱정되는 **사회적 약자**
- 휠체어 이동, 유아 동반 등 접근성이 중요한 **장애인·보호자**
- 한국어가 익숙하지 않은 **외국인 관광객·체류자** (영·중·일 입력 지원)
...
- 응급실 병상, 야간/공휴일 약국·진료기관을 가까운 위치로 빠르게 조회
- `연락처 + 바로 갈 곳 + 카카오맵`을 함께 제공해 빠른 이동 지원
- 안전비상벨, 아동안전지킴이집, 지하철 접근성 정보까지 통합 안내
- 장애인 화장실, 엘리베이터 등 이동약자를 위한 편의 정보 제공
- 한국어·English·中文·日本語 기반 다국어 입력/안내 지원
